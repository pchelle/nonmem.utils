...
metadata:
  ...
  version: "1.0"
  source: https://github.com/posit-dev/skills/blob/main/posit-dev/describe-design/SKILL.md
license: MIT
---
...
- **Paths**: Use relative paths from repository root (`R/nonmem-read.R`)
- **Symbols**: Reference function and class names, not line numbers
- **Format**: `path/to/file.ext` with key symbols listed separately

Avoid:

- **Copying code**: Never paste code into the document. Describe what code does, then reference where to find it.
...
Keep diagrams focused on the specific feature being documented.
